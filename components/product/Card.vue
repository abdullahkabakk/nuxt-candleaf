...
watch(
  () => store.getCartItemById(product.id)?.count,
...
<template>
  <!-- Product Card -->
  <Card
    class="flex flex-col hover:shadow-lg transition-shadow duration-300 ease-in-out hover:bg-primary/20 dark:hover:bg-primary/20 hover:scale-105"
  >
    <!-- Product Image -->
